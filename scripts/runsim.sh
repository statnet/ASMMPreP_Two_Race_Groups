...
#PBS -o /gscratch/csde/deven/Camp/scenarios/adol2race/out
#PBS -e /gscratch/csde/deven/Camp/scenarios/adol2race/out
#PBS -j oe
#PBS -d /gscratch/csde/deven/Camp/scenarios/adol2race
#PBS -m n
