...
heatbath.adol <- function(dat, at){
  ...
  heat.contact.b<-dat$param$heat.prob.contact.b
  heat.trans.b<-dat$param$heat.trans.b
  heat.intensity.b<-dat$param$heat.multiplier.b
  
  heat.contact.w<-dat$param$heat.prob.contact.w
  heat.trans.w<-dat$param$heat.trans.w
  heat.intensity.w<-dat$param$heat.multiplier.w  

  #Scale the intesity of the heatbath with multiplier
  heat.b<-heat.contact.b*heat.intensity.b
  heat.w<-heat.contact.w*heat.intensity.w
  ...
  ids.b<-which(active==1 & debut==1 & race =="B")
  ids.w<-which(active==1 & debut==1 & race =="W")
...
#Calculate the number of Contacts.
  ...
  for(i in 1:length(riskg.vec.w)){
    ...
    infect.new.mat.out.b<-rbind(infect.new.mat.out.n.b,infect.new.mat.out.l.b,infect.new.mat.out.m.b,infect.new.mat.out.h.b,infect.new.mat.out.none.b)
    ...
    if (length(infect.new.mat.out.w$infect.new.w)>0){
      ...
      infect.new.mat.out.w<-rbind(infect.new.mat.out.n.w,infect.new.mat.out.l.w,infect.new.mat.out.m.w,infect.new.mat.out.h.w,infect.new.mat.out.none.w)
